...
extern "C" {
    ...
    Java_com_iauto_juiceohmeter_MainActivity_getBatteryTemperatureFromJNI(
        ...
        jfieldID extraTemperatureFieldID = env->GetStaticFieldID(
            batteryManagerClass,
            "EXTRA_TEMPERATURE",
            "Ljava/lang/String;"
        );
        ...
        jstring extraTemperatureString = (jstring) env->GetStaticObjectField(
            batteryManagerClass,
        ...
        jmethodID getIntExtraMethod = env->GetMethodID(
            intentClass,
            "getIntExtra",
            "(Ljava/lang/String;I)I"
        );
        jint temperature = env->CallIntMethod(
            batteryStatus,
            getIntExtraMethod,
            extraTemperatureString,
            -1
        );
    ...
    Java_com_iauto_juiceohmeter_MainActivity_getBatteryVoltageFromJNI(
            ...
            jobject batteryStatus) {
        jclass intentClass = env->GetObjectClass(batteryStatus);
        jmethodID getIntExtra = env->GetMethodID(
            intentClass,
            "getIntExtra",
            "(Ljava/lang/String;I)I"
        );
    ...
    Java_com_iauto_juiceohmeter_MainActivity_getBatteryCurrentFromJNI(
        ...
        jmethodID getIntProperty = env->GetMethodID(
            batteryManagerClass,
            "getIntProperty",
            "(I)I"
        );
